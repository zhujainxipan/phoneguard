...
public class DbManager {
    ...
    public boolean addInfo(Info info) {
        ...
        if (db.isOpen()) {
            ...
            if (! info.getPhonenumber().contains("+86")) {
                values.put("phonenumber", "+86"+info.getPhonenumber().replace(" ", ""));
            } else {
                values.put("phonenumber", info.getPhonenumber().replace(" ", ""));
            }
    ...
    public List<DuanXin> getDuanXinList() {
        SQLiteDatabase db = phoneGuardSQLiteOpenHelper.getWritableDatabase();
        List<DuanXin> list = new ArrayList<>();
    ...
    public List<TongHua> getTongHuaList() {
        SQLiteDatabase db = phoneGuardSQLiteOpenHelper.getWritableDatabase();
        List<TongHua> list = new ArrayList<>();
